...
export default function NewsCard({ article, index }: { article: Article; index: number }) {
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300"
    >
